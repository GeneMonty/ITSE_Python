...
# Searching a List for an Exact Match

# Summary
        # In this lab, you use what you have learned about searching a list to find an exact match to complete a partially prewritten Python program.
